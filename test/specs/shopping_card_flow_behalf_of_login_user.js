...
const homeMenu = '.active.menu_home';
...
const choosenItemQuantitySelector = '#cart_quantity114';
const quantity = '1';
...
describe('Shoping card flow behalf of login user', async function () {
    ...
    context('adding goods: ', async function () {
        ...
        it(`check the cart and checkout`, async function () {
            ...
            const itemQuantity = await (await $(choosenItemQuantitySelector)).getValue();
